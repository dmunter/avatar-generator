...
<div className="container max-w-max">
  ...
  <div className="" styles = {{margin: '25px', width: '20%', height: '25px'}}>
      ...
      <div className="halie-container">   
        <div className="showcase  font-bold text-white text-center">
          <div className="... ring ring-blue-500 ring-offset-3 rounded-md text-6xl leading-normal">
            <h1 className="">Create your own </h1>
            <h2 className=" uppercase underline decoration-sky-500 text-transparent font-extrabold bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">photorealistic</h2>
            <h1>Ai avatars</h1>
    ...
    <div className="bg-primary-black border border-blue-100 border-t-1 border-l-0 border-r-0 border-b-1 h-48 ...">
      <br></br>
      <div className="m-auto mt-8 min-w-fit bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 w-1/4 rounded-lg text-center ...">
    ...
    <div className="bg-primary-black border border-blue-100 border-t-1 border-l-0 border-r-0 border-b-1">
